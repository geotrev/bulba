...
const nextBundleSHA = getSHA(getFileContent("dist/upgraded-element.js"))
const nextBundleMinSHA = getSHA(getFileContent("dist/upgraded-element.min.js"))
/**
...
if (currentBundleSHA === formattedBundleSHA && currentBundleMinSHA === formattedBundleMinSHA) {
...
if (currentBundleMinSHA !== formattedBundleMinSHA) {
  nextReadmeFile = nextReadmeFile.replace(currentBundleMinSHA, formattedBundleMinSHA)
}
